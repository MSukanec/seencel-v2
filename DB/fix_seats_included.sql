-- ============================================================
-- FIX: get_organization_seat_status con seats_included
-- ============================================================
-- Ejecutar en Supabase para REEMPLAZAR la función anterior
-- 
-- Cambios:
-- - Usa seats_included (no max_members) como seats gratis
-- - max_members ahora es el límite máximo posible
-- ============================================================
...
COMMENT ON FUNCTION public.get_organization_seat_status IS 'Retorna estado de seats usando seats_included (gratis) y max_members (límite), con prorrateo';
