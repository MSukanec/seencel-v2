-- ============================================================
-- Actualizar accept_organization_invitation para manejar
-- re-activación de miembros inactivos (is_active = false)
-- en vez de fallar con unique constraint violation.
-- ============================================================
