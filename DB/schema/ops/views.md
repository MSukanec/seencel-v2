...
### `ops.analytics_at_risk_users_view` (🔓 INVOKER)
...
### `ops.analytics_bounce_rate_view` (🔓 INVOKER)
...
### `ops.analytics_general_kpis_view` (🔓 INVOKER)
...
### `ops.analytics_hourly_activity_view` (🔓 INVOKER)
...
### `ops.analytics_page_engagement_view` (🔓 INVOKER)
...
### `ops.analytics_realtime_overview_view` (🔓 INVOKER)
...
### `ops.analytics_session_duration_view` (🔓 INVOKER)
...
### `ops.analytics_top_users_view` (🔓 INVOKER)
...
### `ops.analytics_user_growth_view` (🔓 INVOKER)
...
### `ops.analytics_user_journeys_view` (🔓 INVOKER)
...
### `ops.analytics_user_session_summary_view` (🔓 INVOKER)
...
### `ops.analytics_users_by_country_view` (🔓 INVOKER)
...
### `ops.ops_alerts_enriched_view` (🔓 INVOKER)
...
### `ops.system_errors_enriched_view` (🔓 INVOKER)
