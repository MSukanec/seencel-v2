...
## Functions & Procedures (chunk 5: log_kanban_card_activity — log_quote_activity)
...
### `log_media_file_folder_activity()` 🔐
...
```sql
CREATE OR REPLACE FUNCTION public.log_media_file_folder_activity()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
```sql
CREATE OR REPLACE FUNCTION public.log_member_billable_change()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
### `log_organization_data_activity()` 🔐
...
```sql
CREATE OR REPLACE FUNCTION public.log_organization_data_activity()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
```sql
CREATE OR REPLACE FUNCTION public.log_project_client_activity()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
```sql
CREATE OR REPLACE FUNCTION public.log_project_data_activity()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
```sql
CREATE OR REPLACE FUNCTION public.log_project_labor_activity()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
```sql
CREATE OR REPLACE FUNCTION public.log_project_modality_activity()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
```sql
CREATE OR REPLACE FUNCTION public.log_project_type_activity()
 RETURNS trigger
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
