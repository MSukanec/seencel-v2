...
| construction_tasks | on_construction_task_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_construction_task_activity() |
...
| site_logs | on_site_logs_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_site_logs_activity() |
