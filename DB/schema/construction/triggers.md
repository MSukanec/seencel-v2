...
| quote_items | on_quote_item_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_quote_item_activity() |
...
| quotes | on_quote_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_quote_activity() |
