...
| construction_tasks | on_construction_task_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_construction_task_activity() |
...
| site_log_types | on_site_log_types_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_site_log_types_activity() |
...
| site_logs | on_site_logs_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_site_logs_activity() |
