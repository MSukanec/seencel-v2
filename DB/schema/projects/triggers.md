...
|-------|---------|--------|--------|--------|
| client_roles | on_client_role_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_client_role_activity() |
...
| contacts | on_contact_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_contact_activity() |
...
| project_clients | on_project_client_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_project_client_activity() |
...
| project_types | on_project_type_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_project_type_activity() |
