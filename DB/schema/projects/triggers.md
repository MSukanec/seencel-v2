...
| project_clients | on_project_client_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_project_client_activity() |
...
| projects | on_project_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_project_activity() |
