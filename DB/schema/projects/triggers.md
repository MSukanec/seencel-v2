...
|-------|---------|--------|--------|--------|
| client_roles | on_client_role_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_client_role_activity() |
...
| contacts | on_contact_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_contact_activity() |
...
| project_types | on_project_type_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_project_type_activity() |
...
| projects | on_project_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_project_activity() |
