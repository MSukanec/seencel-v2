...
## [PROJECTS] Triggers (25)

| Table | Trigger | Timing | Events | Action |
|-------|---------|--------|--------|--------|
| client_portal_settings | set_audit_client_portal | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
| client_roles | on_client_role_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_client_role_activity() |
| client_roles | set_audit_client_roles | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| contact_categories | on_contact_category_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_contact_category_activity() |
...
| project_clients | on_project_client_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_project_client_activity() |
...
| project_labor | on_project_labor_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_project_labor_activity() |
| project_labor | set_updated_by_project_labor | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| project_modalities | on_project_modality_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_project_modality_activity() |
...
| projects | on_project_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_project_activity() |
