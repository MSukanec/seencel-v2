...
| contact_categories | on_contact_category_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_contact_category_activity() |
...
| contacts | on_contact_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_contact_activity() |
