...
| project_labor | on_project_labor_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_project_labor_activity() |
| project_labor | set_updated_by_project_labor | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| project_modalities | on_project_modality_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_project_modality_activity() |
