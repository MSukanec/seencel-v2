...
| client_roles | on_client_role_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_client_role_activity() |
| client_roles | set_audit_client_roles | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| project_clients | on_project_client_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_project_client_activity() |
...
| project_labor | on_project_labor_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_project_labor_activity() |
| project_labor | set_updated_by_project_labor | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
| project_modalities | on_project_modality_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_project_modality_activity() |
...
| project_types | on_project_type_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_project_type_activity() |
