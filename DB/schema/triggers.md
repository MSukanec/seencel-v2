...
| calendar_events | on_calendar_event_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_calendar_event_activity() |
...
| client_commitments | on_client_commitment_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_client_commitment_activity() |
...
| client_payments | on_client_payment_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_client_payment_activity() |
...
| construction_tasks | on_construction_task_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_construction_task_activity() |
...
| financial_operations | on_financial_operation_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_financial_operation_activity() |
...
| general_cost_categories | on_general_cost_categories_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_general_cost_category_activity() |
...
| kanban_boards | on_kanban_board_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_kanban_board_activity() |
...
| kanban_cards | set_updated_by_kanban_cards | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
...
| kanban_comments | on_kanban_comment_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_kanban_comment_activity() |
...
| kanban_labels | on_kanban_label_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_kanban_label_activity() |
...
| kanban_lists | on_kanban_list_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_kanban_child_activity() |
| kanban_lists | set_updated_by_kanban_lists | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| labor_categories | on_labor_category_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_labor_category_activity() |
...
| labor_payments | on_labor_payment_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_labor_payment_activity() |
...
| labor_prices | on_labor_price_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_labor_price_activity() |
...
| material_payments | on_material_payment_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_material_payment_activity() |
...
| media_file_folders | on_media_file_folder_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_media_file_folder_activity() |
...
| organization_data | on_organization_data_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_organization_data_activity() |
...
| organization_external_actors | on_external_actor_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_external_actor_activity() |
| organization_external_actors | set_updated_by_oea | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
| organization_external_actors | trigger_create_contact_on_new_external_actor | AFTER | INSERT | EXECUTE FUNCTION handle_new_external_actor_contact() |
...
| organization_members | log_member_billable_changes | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_member_billable_change() |
...
| organizations | on_organizations_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_organizations_activity() |
...
| partner_contributions | trg_update_balance_contribution | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
| partner_withdrawals | trg_update_balance_withdrawal | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
| payments | notify_payment | AFTER | UPDATE, INSERT | EXECUTE FUNCTION notify_admin_on_payment() |
...
| project_clients | on_project_client_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_project_client_activity() |
...
| project_labor | on_project_labor_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_project_labor_activity() |
...
| project_types | on_project_type_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_project_type_activity() |
...
| site_log_types | on_site_log_types_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_site_log_types_activity() |
...
| site_logs | on_site_logs_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_site_logs_activity() |
...
| subcontract_payments | on_subcontract_payment_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_subcontract_payment_activity() |
...
| subcontracts | on_subcontract_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_subcontract_activity() |
...
| task_recipe_external_services | on_recipe_external_service_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_recipe_external_service_activity() |
...
| task_recipe_labor | on_recipe_labor_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_recipe_labor_activity() |
...
| task_recipe_materials | on_recipe_material_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_recipe_material_activity() |
...
| task_recipe_ratings | trg_recalculate_recipe_rating | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION recalculate_recipe_rating() |
...
| tasks | on_task_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_task_activity() |
...
| users | trg_users_normalize_email | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION users_normalize_email() |
