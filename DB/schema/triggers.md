...
| calendar_events | on_calendar_event_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_calendar_event_activity() |
...
| capital_adjustments | trg_update_balance_adjustment | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
| client_commitments | client_commitments_set_updated_at | BEFORE | UPDATE | EXECUTE FUNCTION update_timestamp() |
| client_commitments | on_client_commitment_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_client_commitment_activity() |
| client_commitments | set_audit_client_commitments | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
...
| client_payments | on_client_payment_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_client_payment_activity() |
...
| client_roles | on_client_role_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_client_role_activity() |
...
| construction_tasks | on_construction_task_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_construction_task_activity() |
...
| contact_categories | on_contact_category_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_contact_category_activity() |
...
| contacts | on_contact_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_contact_activity() |
| contacts | on_contact_link_user | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_contact_link_user() |
...
| financial_operation_movements | on_financial_movement_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_financial_movement_activity() |
...
| financial_operations | on_financial_operation_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_financial_operation_activity() |
...
| forum_posts | trg_update_thread_activity | AFTER | INSERT, DELETE | EXECUTE FUNCTION update_forum_thread_activity() |
| general_cost_categories | on_general_cost_categories_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_general_cost_category_activity() |
...
| general_costs | on_general_costs_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_general_costs_activity() |
...
| import_batches | tr_log_import_activity | AFTER | INSERT, UPDATE | EXECUTE FUNCTION log_import_activity() |
...
| kanban_boards | on_kanban_board_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_kanban_board_activity() |
| kanban_boards | set_updated_by_kanban_boards | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
...
| kanban_cards | trg_notify_kanban_card_assigned | AFTER | INSERT, UPDATE | EXECUTE FUNCTION notify_kanban_card_assigned() |
...
| kanban_comments | on_kanban_comment_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_kanban_comment_activity() |
...
| kanban_labels | on_kanban_label_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_kanban_label_activity() |
...
| kanban_lists | on_kanban_list_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_kanban_child_activity() |
| kanban_lists | set_updated_by_kanban_lists | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| labor_categories | on_labor_category_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_labor_category_activity() |
...
| labor_payments | on_labor_payment_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_labor_payment_activity() |
...
| labor_prices | on_labor_price_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_labor_price_activity() |
...
| material_payments | on_material_payment_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_material_payment_activity() |
...
| material_purchase_order_items | trg_recalculate_po_totals | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION recalculate_po_totals() |
...
| materials | on_material_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_material_activity() |
...
| media_file_folders | on_media_file_folder_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_media_file_folder_activity() |
| media_file_folders | set_updated_by_media_file_folders | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
...
| organization_data | on_organization_data_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_organization_data_activity() |
...
| organization_members | log_member_billable_changes | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_member_billable_change() |
...
| organizations | on_organizations_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_organizations_activity() |
...
| partner_withdrawals | trg_update_balance_withdrawal | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
| payments | notify_payment | AFTER | INSERT, UPDATE | EXECUTE FUNCTION notify_admin_on_payment() |
| payments | notify_user_payment_completed | AFTER | UPDATE, INSERT | EXECUTE FUNCTION notify_user_payment_completed() |
...
| project_labor | on_project_labor_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_project_labor_activity() |
...
| project_modalities | on_project_modality_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_project_modality_activity() |
...
| project_types | on_project_type_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_project_type_activity() |
...
| projects | on_project_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_project_activity() |
...
| quote_items | on_quote_item_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_quote_item_activity() |
...
| quotes | on_quote_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_quote_activity() |
...
| site_log_types | on_site_log_types_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_site_log_types_activity() |
...
| site_logs | on_site_logs_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_site_logs_activity() |
...
| subcontract_payments | on_subcontract_payment_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_subcontract_payment_activity() |
...
| subcontracts | on_subcontract_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_subcontract_activity() |
...
| task_divisions | on_task_division_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_task_division_activity() |
| task_divisions | set_updated_by_task_divisions | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
...
| task_recipe_labor | on_recipe_labor_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_recipe_labor_activity() |
...
| task_recipe_materials | on_recipe_material_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_recipe_material_activity() |
| task_recipe_materials | set_updated_by_task_recipe_materials | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| task_recipe_materials | task_recipe_materials_set_updated_at | BEFORE | UPDATE | EXECUTE FUNCTION set_timestamp() |
| task_recipe_ratings | trg_recalculate_recipe_rating | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION recalculate_recipe_rating() |
...
| tasks | on_task_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_task_activity() |
...
| units | on_unit_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_unit_activity() |
