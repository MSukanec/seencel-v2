...
| task_recipe_materials | on_recipe_material_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_recipe_material_activity() |
...
| task_recipe_ratings | trg_recalculate_recipe_rating | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION catalog.recalculate_recipe_rating() |
...
| units | on_unit_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_unit_activity() |
