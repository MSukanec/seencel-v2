...
| labor_prices | on_labor_price_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_labor_price_activity() |
...
| task_recipe_labor | on_recipe_labor_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_recipe_labor_activity() |
...
| tasks | on_task_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_task_activity() |
...
| units | on_unit_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_unit_activity() |
