...
| labor_prices | on_labor_price_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_labor_price_activity() |
...
| materials | on_material_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_material_activity() |
...
| task_divisions | on_task_division_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_task_division_activity() |
...
| tasks | on_task_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_task_activity() |
