...
| task_recipe_external_services | on_recipe_external_service_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_recipe_external_service_activi... |
...
| task_recipes | on_task_recipe_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_task_recipe_activity() |
...
| tasks | tasks_set_updated_at | BEFORE | UPDATE | EXECUTE FUNCTION set_timestamp() |
