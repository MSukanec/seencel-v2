...
| labor_categories | on_labor_category_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_labor_category_activity() |
...
| materials | on_material_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_material_activity() |
...
| task_recipe_materials | on_recipe_material_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_recipe_material_activity() |
...
| task_recipe_ratings | trg_recalculate_recipe_rating | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION catalog.recalculate_recipe_rating() |
