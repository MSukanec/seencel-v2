...
| labor_categories | on_labor_category_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_labor_category_activity() |
...
| task_recipe_external_services | on_recipe_external_service_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_recipe_external_service_activi... |
...
| task_recipe_ratings | trg_recalculate_recipe_rating | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION catalog.recalculate_recipe_rating() |
| task_recipes | on_task_recipe_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_task_recipe_activity() |
...
| units | on_unit_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_unit_activity() |
