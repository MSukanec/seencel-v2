...
| task_divisions | on_task_division_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_task_division_activity() |
...
| task_recipe_labor | on_recipe_labor_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_recipe_labor_activity() |
