...
| labor_prices | on_labor_price_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_labor_price_activity() |
...
| task_divisions | on_task_division_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_task_division_activity() |
...
| task_recipe_materials | on_recipe_material_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_recipe_material_activity() |
...
| task_recipe_ratings | trg_recalculate_recipe_rating | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION catalog.recalculate_recipe_rating() |
