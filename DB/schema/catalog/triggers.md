...
| task_divisions | on_task_division_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_task_division_activity() |
...
| task_recipes | on_task_recipe_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_task_recipe_activity() |
...
| units | on_unit_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_unit_activity() |
