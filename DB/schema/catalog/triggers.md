...
|-------|---------|--------|--------|--------|
| labor_categories | on_labor_category_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_labor_category_activity() |
...
| labor_prices | on_labor_price_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_labor_price_activity() |
...
| task_divisions | on_task_division_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_task_division_activity() |
...
| task_recipe_external_services | on_recipe_external_service_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_recipe_external_service_activi... |
...
| task_recipe_labor | on_recipe_labor_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_recipe_labor_activity() |
...
| task_recipe_materials | on_recipe_material_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_recipe_material_activity() |
...
| task_recipes | on_task_recipe_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_task_recipe_activity() |
...
| tasks | on_task_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_task_activity() |
...
| units | on_unit_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_unit_activity() |
