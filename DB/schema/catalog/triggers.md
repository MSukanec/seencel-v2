...
| task_recipe_labor | on_recipe_labor_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_recipe_labor_activity() |
...
| tasks | on_task_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_task_activity() |
