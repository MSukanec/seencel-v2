...
| organization_data | on_organization_data_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_organization_data_activity() |
...
| organization_external_actors | on_external_actor_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_external_actor_activity() |
...
| organization_members | log_member_billable_changes | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_member_billable_change() |
...
| organizations | on_organizations_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_organizations_activity() |
