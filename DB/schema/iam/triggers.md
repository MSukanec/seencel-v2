...
| organization_external_actors | on_external_actor_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_external_actor_activity() |
...
| organizations | set_timestamp_organizations | BEFORE | UPDATE | EXECUTE FUNCTION set_timestamp() |
