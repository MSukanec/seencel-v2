...
| organization_external_actors | on_external_actor_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_external_actor_activity() |
...
| organization_members | log_member_billable_changes | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_member_billable_change() |
...
| organizations | on_organizations_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_organizations_activity() |
...
| users | trg_users_normalize_email | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION iam.users_normalize_email() |
