...
| organization_data | on_organization_data_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_organization_data_activity() |
...
| organization_members | log_member_billable_changes | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_member_billable_change() |
