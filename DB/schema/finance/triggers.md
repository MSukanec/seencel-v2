...
| labor_payments | on_labor_payment_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_labor_payment_activity() |
...
| quotes | on_quote_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_quote_activity() |
...
| subcontract_payments | on_subcontract_payment_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_subcontract_payment_activity() |
