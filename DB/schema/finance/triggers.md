...
| capital_adjustments | trg_update_balance_adjustment | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION finance.update_partner_balance_after_cap... |
...
| client_payments | on_client_payment_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_client_payment_activity() |
...
| financial_operation_movements | on_financial_movement_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_financial_movement_activity() |
...
| partner_withdrawals | trg_update_balance_withdrawal | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION finance.update_partner_balance_after_cap... |
