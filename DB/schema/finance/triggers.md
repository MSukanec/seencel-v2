...
| material_purchase_order_items | trg_recalculate_po_totals | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION recalculate_po_totals() |
...
| quote_items | on_quote_item_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_quote_item_activity() |
...
| subcontracts | on_subcontract_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_subcontract_activity() |
