...
| client_payments | on_client_payment_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_client_payment_activity() |
...
| material_purchase_order_items | trg_recalculate_po_totals | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION recalculate_po_totals() |
