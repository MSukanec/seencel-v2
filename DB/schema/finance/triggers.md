...
| client_commitments | on_client_commitment_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_client_commitment_activity() |
...
| general_cost_categories | on_general_cost_categories_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_general_cost_category_activity() |
...
| general_costs | on_general_costs_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_general_costs_activity() |
...
| subcontracts | on_subcontract_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_subcontract_activity() |
