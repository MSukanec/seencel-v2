...
| capital_adjustments | trg_update_balance_adjustment | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION finance.update_partner_balance_after_cap... |
...
| material_payments | on_material_payment_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_material_payment_activity() |
...
| material_purchase_order_items | trg_recalculate_po_totals | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION finance.recalculate_po_totals() |
...
| partner_contributions | trg_update_balance_contribution | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION finance.update_partner_balance_after_cap... |
...
| subcontract_payments | on_subcontract_payment_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_subcontract_payment_activity() |
