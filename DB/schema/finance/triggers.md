...
| general_costs | on_general_costs_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_general_costs_activity() |
...
| partner_withdrawals | trg_update_balance_withdrawal | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
| pdf_templates | update_pdf_templates_updated_at | BEFORE | UPDATE | EXECUTE FUNCTION update_updated_at_column() |
| quote_items | on_quote_item_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_quote_item_activity() |
