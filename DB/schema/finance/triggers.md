...
| capital_adjustments | trg_update_balance_adjustment | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION finance.update_partner_balance_after_cap... |
| client_commitments | client_commitments_set_updated_at | BEFORE | UPDATE | EXECUTE FUNCTION set_timestamp() |
| client_commitments | on_client_commitment_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_client_commitment_activity() |
...
| client_payments | on_client_payment_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_client_payment_activity() |
...
| financial_operation_movements | on_financial_movement_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_financial_movement_activity() |
...
| financial_operations | on_financial_operation_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_financial_operation_activity() |
...
| general_cost_categories | on_general_cost_categories_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_general_cost_category_activity() |
...
| general_costs | on_general_costs_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_general_costs_activity() |
...
| labor_payments | on_labor_payment_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_labor_payment_activity() |
| labor_payments | set_updated_by_labor_payments | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| material_payments | on_material_payment_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_material_payment_activity() |
...
| material_purchase_order_items | trg_recalculate_po_totals | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION finance.recalculate_po_totals() |
...
| partner_contributions | trg_update_balance_contribution | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION finance.update_partner_balance_after_cap... |
| partner_withdrawals | trg_update_balance_withdrawal | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION finance.update_partner_balance_after_cap... |
| quote_items | on_quote_item_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_quote_item_activity() |
...
| quotes | on_quote_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_quote_activity() |
...
| subcontract_payments | on_subcontract_payment_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_subcontract_payment_activity() |
| subcontract_payments | set_updated_by_subcontract_payments | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
| subcontracts | on_subcontract_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_subcontract_activity() |
