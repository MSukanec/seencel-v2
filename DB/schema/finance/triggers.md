...
| client_payments | on_client_payment_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_client_payment_activity() |
...
| financial_operations | on_financial_operation_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_financial_operation_activity() |
...
| quote_items | on_quote_item_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_quote_item_activity() |
...
| quotes | on_quote_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_quote_activity() |
