...
| capital_adjustments | trg_update_balance_adjustment | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
...
| client_payments | on_client_payment_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_client_payment_activity() |
...
| client_roles | on_client_role_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_client_role_activity() |
| client_roles | set_audit_client_roles | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| contact_categories | on_contact_category_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_contact_category_activity() |
...
| contacts | on_contact_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_contact_activity() |
...
| financial_operation_movements | on_financial_movement_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_financial_movement_activity() |
...
| financial_operations | on_financial_operation_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_financial_operation_activity() |
...
| general_costs | on_general_costs_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_general_costs_activity() |
...
| kanban_boards | on_kanban_board_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_kanban_board_activity() |
...
| kanban_cards | on_kanban_card_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_kanban_child_activity() |
...
| kanban_comments | on_kanban_comment_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_kanban_comment_activity() |
| kanban_comments | set_updated_by_kanban_comments | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
| kanban_labels | kanban_labels_set_updated_at | BEFORE | UPDATE | EXECUTE FUNCTION set_timestamp() |
| kanban_labels | on_kanban_label_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_kanban_label_activity() |
...
| kanban_lists | set_updated_by_kanban_lists | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
...
| labor_payments | set_updated_by_labor_payments | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
...
| material_payments | on_material_payment_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_material_payment_activity() |
...
| materials | on_material_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_material_activity() |
...
| media_file_folders | on_media_file_folder_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_media_file_folder_activity() |
...
| organization_external_actors | on_external_actor_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_external_actor_activity() |
...
| partner_contributions | trg_update_balance_contribution | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
...
| project_clients | on_project_client_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_project_client_activity() |
...
| project_labor | on_project_labor_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_project_labor_activity() |
...
| project_modalities | on_project_modality_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_project_modality_activity() |
...
| site_log_types | on_site_log_types_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_site_log_types_activity() |
...
| subcontract_payments | on_subcontract_payment_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_subcontract_payment_activity() |
...
| subcontracts | set_updated_by_subcontracts | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
...
| task_recipe_external_services | set_updated_by_task_recipe_external_services | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
| task_recipe_external_services | task_recipe_external_services_set_updated_at | BEFORE | UPDATE | EXECUTE FUNCTION set_timestamp() |
| task_recipe_labor | on_recipe_labor_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_recipe_labor_activity() |
...
| task_recipe_ratings | trg_recalculate_recipe_rating | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION recalculate_recipe_rating() |
| task_recipes | on_task_recipe_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_task_recipe_activity() |
