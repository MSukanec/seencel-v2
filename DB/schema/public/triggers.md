...
| capital_adjustments | trg_update_balance_adjustment | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
| client_commitments | client_commitments_set_updated_at | BEFORE | UPDATE | EXECUTE FUNCTION update_timestamp() |
| client_commitments | on_client_commitment_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_client_commitment_activity() |
...
| client_roles | on_client_role_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_client_role_activity() |
...
| financial_operation_movements | on_financial_movement_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_financial_movement_activity() |
...
| financial_operations | on_financial_operation_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_financial_operation_activity() |
...
| general_costs | on_general_costs_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_general_costs_activity() |
| general_costs | set_updated_by_general_costs | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
| general_costs_payments | on_gc_payments_audit | AFTER | INSERT, UPDATE | EXECUTE FUNCTION log_general_costs_payments_activity() |
...
| kanban_lists | on_kanban_list_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_kanban_child_activity() |
| kanban_lists | set_updated_by_kanban_lists | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
| labor_payments | on_labor_payment_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_labor_payment_activity() |
...
| material_purchase_order_items | trg_recalculate_po_totals | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION recalculate_po_totals() |
...
| media_file_folders | on_media_file_folder_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_media_file_folder_activity() |
...
| organization_external_actors | on_external_actor_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_external_actor_activity() |
...
| organizations | on_organizations_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_organizations_activity() |
...
| partner_contributions | trg_update_balance_contribution | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
...
| project_modalities | on_project_modality_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_project_modality_activity() |
...
| projects | on_project_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_project_activity() |
...
| site_log_types | on_site_log_types_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_site_log_types_activity() |
...
| site_logs | on_site_logs_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_site_logs_activity() |
