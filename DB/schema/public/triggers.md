...
| media_files | on_media_file_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_media_file_activity() |
...
| media_links | on_media_link_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_media_link_activity() |
...
| saved_views | set_updated_by_saved_views | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION handle_updated_by() |
