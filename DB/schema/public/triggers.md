...
| general_cost_categories | on_general_cost_categories_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_general_cost_category_activity() |
...
| general_costs | on_general_costs_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_general_costs_activity() |
...
| kanban_boards | on_kanban_board_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_kanban_board_activity() |
...
| kanban_cards | on_kanban_card_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_kanban_child_activity() |
...
| kanban_comments | on_kanban_comment_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_kanban_comment_activity() |
...
| material_payments | on_material_payment_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_material_payment_activity() |
...
| subcontracts | on_subcontract_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_subcontract_activity() |
