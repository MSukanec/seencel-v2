...
| calendar_events | on_calendar_event_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_calendar_event_activity() |
...
| contact_categories | on_contact_category_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_contact_category_activity() |
...
| general_cost_categories | on_general_cost_categories_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_general_cost_category_activity() |
...
| kanban_boards | on_kanban_board_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_kanban_board_activity() |
...
| kanban_cards | on_kanban_card_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_kanban_child_activity() |
...
| material_payments | on_material_payment_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_material_payment_activity() |
...
| materials | on_material_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_material_activity() |
...
| organization_external_actors | on_external_actor_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_external_actor_activity() |
...
| organization_members | log_member_billable_changes | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_member_billable_change() |
...
| partner_contributions | trg_update_balance_contribution | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
| partner_withdrawals | trg_update_balance_withdrawal | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION update_partner_balance_after_capital_cha... |
...
| project_labor | on_project_labor_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION log_project_labor_activity() |
...
| project_types | on_project_type_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION log_project_type_activity() |
...
| quote_items | on_quote_item_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_quote_item_activity() |
...
| site_log_types | on_site_log_types_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION log_site_log_types_activity() |
...
| site_logs | on_site_logs_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_site_logs_activity() |
...
| task_recipe_external_services | on_recipe_external_service_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION log_recipe_external_service_activity() |
...
| task_recipe_labor | on_recipe_labor_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION log_recipe_labor_activity() |
...
| task_recipe_ratings | trg_recalculate_recipe_rating | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION recalculate_recipe_rating() |
...
| tasks | on_task_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION log_task_activity() |
| tasks | set_updated_by_tasks | BEFORE | INSERT, UPDATE | EXECUTE FUNCTION handle_updated_by() |
