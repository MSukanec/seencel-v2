...
## [PUBLIC] Indexes (26, excluding PKs)
...
| media_links | idx_media_links_active | `CREATE INDEX idx_media_links_active ON public.media_links USING btree (organi...` |
...
| saved_views | idx_saved_views_created_by | `CREATE INDEX idx_saved_views_created_by ON public.saved_views USING btree (cr...` |
| saved_views | idx_saved_views_org_entity | `CREATE INDEX idx_saved_views_org_entity ON public.saved_views USING btree (or...` |
