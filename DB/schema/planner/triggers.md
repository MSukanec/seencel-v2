...
| kanban_cards | on_kanban_card_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_kanban_child_activity() |
...
| kanban_comments | on_kanban_comment_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_kanban_comment_activity() |
...
| kanban_lists | on_kanban_list_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_kanban_child_activity() |
