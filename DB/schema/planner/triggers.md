...
|-------|---------|--------|--------|--------|
| calendar_events | on_calendar_event_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_calendar_event_activity() |
...
| kanban_boards | on_kanban_board_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_kanban_board_activity() |
...
| kanban_cards | kanban_set_card_board_id | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION planner.kanban_set_card_board_id() |
...
| kanban_comments | on_kanban_comment_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_kanban_comment_activity() |
...
| kanban_labels | on_kanban_label_audit | AFTER | INSERT, UPDATE, DELETE | EXECUTE FUNCTION audit.log_kanban_label_activity() |
...
| kanban_lists | on_kanban_list_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_kanban_child_activity() |
