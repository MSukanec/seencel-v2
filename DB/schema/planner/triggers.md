...
|-------|---------|--------|--------|--------|
| calendar_events | on_calendar_event_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_calendar_event_activity() |
...
| kanban_cards | kanban_auto_complete_card | BEFORE | UPDATE, INSERT | EXECUTE FUNCTION planner.kanban_auto_complete_card() |
...
| kanban_cards | on_kanban_card_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_kanban_child_activity() |
...
| kanban_comments | on_kanban_comment_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_kanban_comment_activity() |
...
| kanban_lists | on_kanban_list_audit | AFTER | UPDATE, INSERT, DELETE | EXECUTE FUNCTION audit.log_kanban_child_activity() |
