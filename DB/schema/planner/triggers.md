...
|-------|---------|--------|--------|--------|
| calendar_events | on_calendar_event_audit | AFTER | DELETE, UPDATE, INSERT | EXECUTE FUNCTION audit.log_calendar_event_activity() |
...
| kanban_boards | on_kanban_board_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_kanban_board_activity() |
...
| kanban_cards | on_kanban_card_audit | AFTER | DELETE, INSERT, UPDATE | EXECUTE FUNCTION audit.log_kanban_child_activity() |
...
| kanban_comments | on_kanban_comment_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_kanban_comment_activity() |
...
| kanban_labels | on_kanban_label_audit | AFTER | INSERT, DELETE, UPDATE | EXECUTE FUNCTION audit.log_kanban_label_activity() |
...
| kanban_lists | on_kanban_list_audit | AFTER | UPDATE, DELETE, INSERT | EXECUTE FUNCTION audit.log_kanban_child_activity() |
