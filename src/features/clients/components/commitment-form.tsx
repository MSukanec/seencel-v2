                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <FormField
                            ...
                            render={({ field }) => {
                                ...
                                if (initialData?.id) {
                                    // Try to find name in clients list or use initialData nested structure
                                    const clientName = clients.find(c => c.id === field.value)?.contact_full_name
                                        || initialData.client?.contact?.full_name
                                        || "Cliente";
                                    ...
                                    return (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input value={clientName} disabled className="bg-muted text-muted-foreground opacity-100" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    );
