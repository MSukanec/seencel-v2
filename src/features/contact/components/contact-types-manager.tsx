...
export function ContactTypesManager({ organizationId, initialTypes }: ContactTypesManagerProps) {
    ...
    const filteredTypes = types.filter(type => {
        ...
        const isSystem = !type.organization_id;
        const matchesOrigin = originFilter.size === 0 ||
            (originFilter.has("system") && isSystem) ||
            (originFilter.has("organization") && !isSystem);
                ...
                filterContent={
                    <FacetedFilter
                        ...
                        options={[
                            ...
                            { label: "Organización", value: "organization", icon: Building2 }
                        ]}
