...
import { Coins, Wallet as WalletIcon, Settings2, Plus, Trash2, Check, X, Lightbulb, Lock } from "lucide-react";
    ...
    return (
        <div className="space-y-6 max-w-5xl mx-auto">
            <div className="flex justify-between items-center border-b pb-6">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight">Congiuración Financiera</h2>
