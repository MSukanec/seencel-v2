    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card
                    className={cn(
                        "transition-all border-muted/50",
                        "group relative overflow-hidden bg-muted/5 opacity-60 cursor-not-allowed"
                    )}
                >
                    {/* Badge */}
                    ...
                    <CardHeader className="pb-3">
                        ...
                        <CardTitle className="text-lg text-muted-foreground">Tarea Paramétrica</CardTitle>
                        <CardDescription>
