...
/**
 * Server Component: Quote Detail Page
 * 
 * Fetches quote data and renders the detail view with tabs.
 * Located at: /organization/quotes/[quoteId]
 */
export async function QuoteDetailPage({ params, searchParams }: QuoteDetailPageProps) {
    ...
    return (
        <Tabs defaultValue={defaultTab} className="h-full flex flex-col">
            ...
            >
                ...
                <TabsContent value="items" className="flex-1 m-0 overflow-hidden data-[state=inactive]:hidden">
                    <ContentLayout variant="wide" className="h-full overflow-y-auto">
                        <QuoteBaseView
                            quote={quote}
                            items={items}
                ...
                {isContract && (
                    <TabsContent value="change_orders" className="flex-1 m-0 overflow-hidden data-[state=inactive]:hidden">
                        <ContentLayout variant="wide" className="h-full overflow-y-auto">
