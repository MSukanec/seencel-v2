...
export function QuoteForm({
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        setIsLoading(true);
        const toastId = toast.loading(mode === "create" ? "Creando presupuesto..." : "Guardando cambios...");
        ...
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                    ...
                    {/* Row 1: Fecha del Presupuesto | Válido hasta */}
                    ...
                    {/* Row 2: Tipo | Estado */}
                    <div className="md:col-span-6">
                        <FormGroup label="Tipo" htmlFor="quote_type" required>
                            <Select name="quote_type" defaultValue={initialData?.quote_type || "quote"}>
                                <SelectTrigger>
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                    ...
                    {/* Row 3: Cliente | Proyecto (condicional) */}
                    ...
                    {/* Row 4: Moneda | Cotización (solo si hay más de 1 moneda) */}
                    ...
                    {/* Row 5: Etiqueta impuesto | Impuesto % | Descuento % (3 columnas) */}
