                ...
                <div className="relative flex flex-col items-center text-center space-y-8 max-w-md">
                    ...
                    >
                        {isCourse ? (
                            ...
                            <>
                                <Button size="lg" className="flex-1 h-12 text-base font-medium" onClick={() => handleNavigate('/settings/members')}>
                                    <Users className="w-5 h-5 mr-2" />
                                    {t("success.seats.ctaPrimary")}
                                </Button>
                                <Button size="lg" variant="outline" className="flex-1 h-12" onClick={() => handleNavigate('/settings/billing')}>
