...
// Dark map style (same as location-manager)
const darkMapStyle = [
            ...
            >
                ...
                {projects.map((project) => (
                    ...
                    >
                        ...
                        >
                            <div className="relative w-12 h-12 bg-[#83cc16] rounded-full rounded-br-none rotate-45 flex items-center justify-center border-2 border-white shadow-sm">
            ...
            <div className="absolute bottom-6 left-6 z-10">
                <div className="bg-background/90 backdrop-blur-xl border border-white/20 rounded-lg px-4 py-2 shadow-lg">
                    <div className="flex items-center gap-2 text-sm">
                        <div className="w-3 h-3 rounded-full bg-[#83cc16]" />
