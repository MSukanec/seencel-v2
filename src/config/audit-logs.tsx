...
export const moduleRoutes: Record<string, string> = {
    ...
    'organization_invitations': '/settings/members',
    'design_documents': '/organization/files',
    'media_files': '/organization/files',
    'media_links': '/organization/files',
    'capital_contributions': '/organization/finance?view=capital',
    'capital_participants': '/organization/finance?view=capital',
