        ...
        <div className="flex flex-col h-full">
            <HeaderTitleUpdater title={
                <span className="flex items-center gap-2 text-sm text-muted-foreground">
                    Admin <span className="text-muted-foreground/40">/</span> <span className="text-foreground font-medium">Finanzas</span>
                </span>
            } />

            <Tabs defaultValue="subscriptions" className="w-full flex-1 flex flex-col">
                <HeaderPortal>
                ...
                <div className="flex-1 bg-muted/5 p-8">
                    <TabsContent value="subscriptions" className="m-0 max-w-5xl mx-auto space-y-6">
                    ...
                    <TabsContent value="invoices" className="m-0 max-w-5xl mx-auto space-y-6">
                        <div className="p-8 border border-dashed rounded-lg bg-background text-center">
                            <div className="mx-auto w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                    ...
                    <TabsContent value="plans" className="m-0 max-w-5xl mx-auto space-y-6">
                        <div className="p-8 border border-dashed rounded-lg bg-background text-center">
                            <div className="mx-auto w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
