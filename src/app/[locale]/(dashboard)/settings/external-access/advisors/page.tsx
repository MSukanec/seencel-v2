...
export async function generateMetadata(): Promise<Metadata> {
    return {
        title: "Asesores Externos | Accesos Externos | Seencel",
        description: "Gestión de contadores y otros asesores externos",
        robots: "noindex, nofollow",
    };
}

export default async function ExternalAccessAdvisorsPage() {
