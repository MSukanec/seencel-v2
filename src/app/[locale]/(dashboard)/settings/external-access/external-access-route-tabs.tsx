...
export function ExternalAccessRouteTabs() {
    ...
    const tabs = [
        { value: "advisors", label: "Colaboradores", href: "/settings/external-access" },
        { value: "clients", label: "Clientes", href: "/settings/external-access/clients" }
    ];
        ...
        >
            ...
            <div className="bg-shell px-2 pb-1.5 pt-1 rounded-b-xl flex items-center justify-center -mx-[0.5px]">
                <PageHeaderTabs>
                    <div role="tablist">
                        {tabs.map(tab => {
                            const isActive = tab.href === "/settings/external-access"
                                ? pathname === "/settings/external-access" || pathname === "/settings/external-access/advisors"
