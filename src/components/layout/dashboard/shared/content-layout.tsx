...
const variantStyles = {
    ...
    wide: "px-2 md:px-8 pt-6 pb-20 overflow-y-auto h-full",
...
export function ContentLayout({
    ...
    if (variant === 'narrow') {
        return (
            <div className={cn("h-full w-full overflow-y-auto bg-transparent", className)}>
                <div className="mx-auto max-w-4xl px-2 pt-8 pb-20 md:px-8">
                    {children}
                </div>
            </div>
        )
    ...
    if (variant === 'settings') {
        return (
            <div className={cn("h-full w-full overflow-y-auto bg-transparent", className)}>
                <div className="mx-auto max-w-5xl px-2 pt-8 pb-20 md:px-8">
                    {children}
                </div>
            </div>
        )
    ...
    if (variant === 'wide') {
        return (
            <div className={cn("h-full w-full overflow-y-auto bg-transparent flex flex-col", className)}>
                <div className="w-full px-2 py-6 md:px-8 flex-1 flex flex-col min-h-0">
                    {children}
                </div>
            </div>
        )
