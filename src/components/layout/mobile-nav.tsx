...
import { ProjectSelectorWrapper } from "./project-selector-wrapper";
    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="w-[100vw] sm:w-[100vw] p-0 flex flex-col border-none">
                ...
                {/* Footer: Project Selector (Left) + Avatar (Right) */}
                <div className="border-t p-4 mt-auto bg-background/50 backdrop-blur-xl">
                    <div className="flex items-center justify-between gap-4 w-full">

                        {/* 1. Project Selector Wrapper (Flex Grow to Max) */}
                        <div className="flex-1 w-full min-w-0">
                            {/* We need to modify Wrapper to be VISIBLE on mobile, currently it has 'hidden md:block' */}
                            <ProjectSelectorWrapper className="!block !mr-0 w-full" />
                        </div>
