...
/**
 * SearchableSelect - A Select component with search/filter functionality
 * 
                        ...
                        <CommandGroup>
                            {options.map((option) => (
                                <CommandItem
                                    ...
                                    value={option.label}
                                    onSelect={() => {
                                        // We use the ID from the option closure, not the label/value from cmdk
                                        // console.log("Selected:", option.value); 
                                        onValueChange(option.value);
                                        setOpen(false);
                                    }}
                                    className={cn(
                                        // Exact same styles as SelectItem
