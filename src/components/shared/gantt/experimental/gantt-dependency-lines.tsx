...
export const GanttDependencyLines = React.memo(function GanttDependencyLines({
    ...
    const lines = useMemo(() => {
        ...
        return dependencies.map((dep) => {
            ...
            // Horizontal line Y = midpoint between the two bars (works with variable heights)
            const horizontalY = (fromPos.y + toPos.y) / 2 + GANTT_BAR_VERTICAL_PADDING + GANTT_BAR_HEIGHT / 2;
