...
> **Alcance**: Flujo completo desde que un usuario presiona "Crear Organización" hasta que aterriza en el dashboard con su nueva org activa — incluyendo tipo de org, nombre, logo, y toda la cadena SQL de setup.
...
2. Ingresa nombre y logo
3. Presiona "Crear y Continuar"

En el backend, un single RPC (`iam.handle_new_organization`) ejecuta 9 pasos atómicos: crea la org, roles, miembro, permisos, monedas, billeteras, preferencias, tablero Kanban inicial, y activa la org como última. Al finalizar, redirige al dashboard.
...
| Organization Currencies | Moneda default (ARS) | `finance.organization_currencies` |
